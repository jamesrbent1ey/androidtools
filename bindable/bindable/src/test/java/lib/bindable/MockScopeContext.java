...
public class MockScopeContext extends Context implements UIScope
{
    @Override
    ...
    @Override
    public SQLiteDatabase openOrCreateDatabase(String name, int mode,
            SQLiteDatabase.CursorFactory factory, @Nullable DatabaseErrorHandler errorHandler)
    {
        return null;
    }
    ...
    @Override
    public void startIntentSender(IntentSender intent, @Nullable Intent fillInIntent, int flagsMask,
    ...
    @Override
    public void startIntentSender(IntentSender intent, @Nullable Intent fillInIntent, int flagsMask,
            int flagsValues, int extraFlags, @Nullable Bundle options)
    ...
    @Override
    public void addModelObserver(UIModelObserver observer)
    {

    }

    @Override
    public void removeModelObserver(UIModelObserver observer)
    {

    }

    public void test(UIBindable bindable)
    {

    }

    public void testSelected(UIBindable any, AdapterView any1, int anyInt)
    {
